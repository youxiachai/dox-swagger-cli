...
exports.buildApiFile = function (program) {
    ...
    var outputDir = path.join(basePath, program.output);
...
//加载模型定义
    ...
    ncp(defaultClientDir, outputDir, {clobber : false}, function (){
        var defaultIndexFile = path.join(outputDir, 'index.html');
        ...
        fs.writeFileSync(defaultIndexFile, ejs.render(indexFile, {apiurl : program.basePath + '/api-docs'}));
